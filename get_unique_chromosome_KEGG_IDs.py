...
"""
get_unique_chromosome_KEGG_IDs.py by Rohan Maddamsetti.

This script gets all unique KEGG IDs in ../results/successful_chromosome_GhostKOALA_ko_results.tsv,
...
Usage: python get_unique_KEGG_IDs.py > ../results/unique_chromosome_KEGG_IDs.tsv
...
unique_KEGG_set = set()
with open("../results/successful_chromosome_GhostKOALA_ko_results.tsv") as infh:
    for line in infh:
